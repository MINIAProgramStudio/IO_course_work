...
class GeneticSolver:
    def __init__(self, func, pop_size, children, starting_overpop, dimensions, minmax, mutation_prob, mutation_pow, seeking_min = False, clever_mutation = False):
        ...
        self.clever_mutation = clever_mutation
