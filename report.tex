...
\begin{figure}[H]
  \center
  \includegraphics[width=\textwidth]{HSVContext2.png}
...
\begin{figure}[H]
  \center
  \includegraphics[width=\textwidth]{HSVContext3.png}
  \textbf{\caption{Третій набір правил застосований до зображення}}
  \label{fig:HSVContext3}
\end{figure}

\subsection{Отримання границь}
Для отримання контексту у вигляді границь об'єктів необхідно застосувати матричний фільтр:
\[
kernel = 
\begin{pmatrix}
-1 & -1 & -1\\
